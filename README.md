...
* Total Donations: $0
* Total Time Spent Creating and Maintaining this: ~71 hours
...
Fork, Edit the code for the beacons, then run the **compile_code** powershell script to turn it into Full Deploy Code.
